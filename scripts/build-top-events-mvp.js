...
const plans = {
  ...
  "germania-paraguay": {
    ...
    context: {
      ...
      goal: {
        strength: "Germania proiettata a produrre quasi tutto il punteggio; 3-0 e 2-0 sono gli scenari principali.",
        risk: "Una transizione di Enciso o Almirón può compromettere i mercati No Goal.",
      },
      corner: {
      ...
      tiri: {
        strength: "Germania proiettata a 17-22 tiri; Havertz, Musiala, Sané e Wirtz sono centrali, mentre Enciso è il principale sbocco paraguayano.",
    ...
    specs: [
      ...
      ["UNDER/OVER", /U\/O 2\.5$/, "OVER", "goal", "Il 3-0 centrale sostiene l'Over 2,5."],
      ["GOAL/NOGOAL", /GOAL\/NO GOAL/, "NOGOAL", "goal", "No Goal è una delle scelte principali dell'analisi."],
      ["UNDER/OVER", /U\/O 4\.5$/, "UNDER", "goal", "Protezione contro una goleada oltre il range centrale 2-0/3-0/3-1."],
      ...
      ["U/O TIRI TOTALI SQUADRA X", /SQUADRA 1: U\/O 16\.5 TIRI TOTALI/, "OVER", "tiri", "Germania proiettata a 17-22 tiri."],
      ["U/O TIRI TOTALI SQUADRA X", /SQUADRA 1: U\/O 17\.5 TIRI TOTALI/, "OVER", "tiri", "Linea interna alla proiezione tedesca, con rischio medio."],
      ["U/O TIRI IN PORTA SQUADRA X", /SQUADRA 1: U\/O 5\.5 TIRI IN PORTA/, "OVER", "tiri", "La proiezione tedesca è 6-9 tiri nello specchio."],
      ["U/O TIRI TOTALI GIOCATORE (DUO) INC TS", /ENCISO C\. U\/O 1\.5/, "OVER", "tiri", "Enciso è uno dei soli profili paraguayani indicati per 2+ tiri."],
      ...
      ["U/O TIRI TOTALI GIOCATORE (DUO) INC TS", /MUSIALA J\. U\/O 2\.5/, "OVER", "tiri", "Musiala è stimato nella fascia 2-4 tiri."],
      ["U/O TIRI TOTALI GIOCATORE (DUO) INC TS", /MUSIALA J\. U\/O 3\.5/, "OVER", "tiri", "Variante più aggressiva ma compatibile con il ruolo fra le linee."],
