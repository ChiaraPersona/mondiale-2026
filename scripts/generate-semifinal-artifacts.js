...
const data = [
  {
    ...
    cards: [
      ["Tchouameni", "Medio-alto", "Zona Rodri/Olmo: rischio fallo tattico se la Spagna pulisce la pressione."],
      ["Cucurella", "Medio", "Lato esposto agli strappi di Dembele e alle sovrapposizioni francesi."],
  ...
  },
  {
    ...
    cards: [
      ["Romero", "Alto", "Duelli diretti con Kane e attacchi inglesi sulle seconde palle."],
